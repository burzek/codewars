...
public class CodeWarsTests {
	...
	public void ZeroOrInfinityTest() {
		...
		assertEquals(1.2125, GoingToZeroOrInfinity.going(523), DELTA);
		assertEquals(1.2125, GoingToZeroOrInfinity.going(6), DELTA);
		assertEquals(1.173214, GoingToZeroOrInfinity.going(7), DELTA);
